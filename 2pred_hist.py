...
def predicted_histogram(ds, field, bins=30):
    ...
    # 2. Çizgi: Wind Tahmini (Mavi kesikli çizgi) -> Artık eski 3.37 değil, tam olarak hocanın istediği 2.93!
    ...
    output_path = f"/scratch/hpc-prf-radmix/hpcbeoe/Mach4_test/id0/{field}_predicted_hist_2line.png"
...
if __name__ == "__main__":
    ...
    print("\n[Mükemmel!] İstediğin tüm histogramlar doğru 2.93 değeriyle başarıyla güncellendi.")
