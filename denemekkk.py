...
make_scatter(
    "Mach",
    r"Wind Mach Number ($M$)",
    "growth_vs_mach.png",
    r"Cold Gas Growth Rate vs Mach Number",
)
...
print("\n--- SIMÜLASYON MACH DEĞERLERİ ---")
print(res_df[["sim", "Mach", "post_T_ratio", "growth_rate"]])